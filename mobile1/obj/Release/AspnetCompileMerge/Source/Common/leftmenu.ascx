...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="/part/part_list.aspx"><i class="fa fa-laptop"></i> <span>부서 게시판</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/Product/demo.aspx"><i class="fa fa-circle-o"></i><font size="2"> 데모</font></a></li>
              <li><a href="/Product/RMA.aspx"><i class="fa fa-circle-o"></i><font size="2"> RMA</font></a></li>
          </ul>
        </li>
