...
namespace mobile1.Product
{
    public partial class Demo : System.Web.UI.Page
    {
        ...
        private void PAGEADD(int pagecount, int nowpage)
        {
            ...
            SB.Append("<li>" + "<a href='demo.aspx?nowpage=" + 1 + " &startdate=" + startdate.Text + "&enddate=" + enddate.Text + "&search=" + Request["search"] + "&type=" + Request["type"] + "&insort=" + Request["insort"] + "&outsort=" + Request["outsort"] + "'>" + "<span aria-hidden='true'> &laquo;</span>" + "</a>" + "<li>");
            if (pagecount == 0)
            {
                SB.Append("<li> " + "<a href='demo.aspx?nowpage=" + 1 + " &startdate=" + startdate.Text + "&enddate=" + enddate.Text + "&search=" + Request["search"] + "&type=" + Request["type"] + "&insort=" + Request["insort"] + "&outsort=" + Request["outsort"] + "'>" + 1 + "</a>" + " <li>");
            }
            int nowlist = 0;
            if (nowpage > 5)
            {
            ...
            for (int i = nowlist; i <= pagecount - 1; i++)
            {
                ...
                if (i == nowpage)
                {
                    SB.Append("<li class='page-item active'> " + "<a href='demo.aspx?nowpage=" + i + " &startdate=" + startdate.Text + "&enddate=" + enddate.Text + "&search=" + Request["search"] + "&type=" + Request["type"] + "&sort=" + Request["sort"] + "&insort=" + Request["insort"] + "&outsort=" + Request["outsort"] + "'>" + i + "</a>" + " <li>");
                }
                else
                {
                    SB.Append("<li> " + "<a href='demo.aspx?nowpage=" + i + " &startdate=" + startdate.Text + "&enddate=" + enddate.Text + "&search=" + Request["search"] + "&type=" + Request["type"] + "&sort=" + Request["sort"] + "&insort=" + Request["insort"] + "&outsort=" + Request["outsort"] + "'>" + i + "</a>" + " <li>");
                }
            }

            SB.Append("<li>" + "<a href='demo.aspx?nowpage=" + (pagecount - 1) + " &startdate=" + startdate.Text + "&enddate=" + enddate.Text + "&search=" + Request["search"] + "&type=" + Request["type"] + "&insort=" + Request["insort"] + "&outsort=" + Request["outsort"] + "'>" + "<span aria-hidden='true'> &raquo;</span>" + "</a>" + "<li>");
            SB.Append("</ul>");
        ...
        private void TBLLOAD()
        {
            ...
            string SQL2 = "select count(*) as count from product_demo where  CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' ";
            ...
            {
                SQL2 = "select count(*) as count from product_demo where product like '%" + Search.Text + "%' and CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' ";

            }
            if (DropDownList1.SelectedValue == "5")
            {
                SQL2 = "select count(*) as count from product_demo where serial like '%" + Search.Text + "%' and CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' ";

            }
            if (Request.QueryString["insort"] == "insort")
            {
                SQL2 = "select count(*) as count from product_demo where outdate is null and serial like '%" + Search.Text + "%' and CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' ";

            }
            if (Request.QueryString["outsort"] == "outsort")
            {
                SQL2 = "select count(*) as count from product_demo where outdate is not null and serial like '%" + Search.Text + "%' and CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' ";
            ...
            SqlDataAdapter ADT = new SqlDataAdapter("product_demo_sp", DB);
            ...
            else if (DropDownList1.SelectedValue == "5")
            {
                ...
                {
                    ADT.SelectCommand.Parameters.AddWithValue("@search", "where outdate is null and to_locserialation like '%" + Search.Text + "%' and  CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' order by indate desc");
        ...
        private void TBLADD(string product, string serial, string indate, string outdate, string up_user, string qty, string no, string tempno, string from_location, string to_location, string out_user)
        {
            ...
            TD.Attributes["style"] = "text-align : center; vertical-align:middle; cursor:pointer;";
            TD.Attributes.Add("Onclick", "go2('" + no.ToString() + "', '" + "Demo" + "')");
            TR.Cells.Add(TD);
            ...
            {
                TD.Text = product.Substring(0, 10) + ".....";
            }
            else
            {
        ...
        {
            Response.Redirect("demo.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&startdate=" + startdate.Text + "&enddate=" + enddate.Text);
        }
        ...
        {
            Response.Redirect("demo.aspx?sort=" + HiddenField1.Value);
        }
        protected void Button5_ServerClick(object sender, EventArgs e)
        {
            Response.Redirect("demo.aspx?nowpage=" + 1 + "&search=" + Search.Text + "&type=" + DropDownList1.SelectedValue + "&type2=" + DropDownList2.SelectedValue
                + "&insort=insort");
        }
