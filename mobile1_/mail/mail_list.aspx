<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="mail_list.aspx.cs" Inherits="mobile1.mail.mail_list"  %>
...
<body class="hold-transition skin-blue sidebar-mini">
    <form id="form1" name="form1" runat="server" style="height:100%;"  defaultbutton="button1">
          ...
          <div class="box box-primary" style="z-index:100;">
            <div class="box-header with-border">
              ...
              <div class="pull-right"  style="float:left; ">
                 <asp:TextBox  ID="Search" runat="server" class="form-control input-sm" placeholder="메일 검색" style="width:140px;"  ></asp:TextBox>
                  <%--<input type="text" id="Search" style="width:140px;" class="form-control input-sm" runat="server" placeholder="메일 검색" >--%>
              </div>
                <div class="pull-right"  style="float:left;">
                      <asp:DropDownList ID="DropDownList1" runat="server" Height="30"  Class="form-control" Font-Size="Small" Width="90px" >
                                  <asp:ListItem Value="0">선택</asp:ListItem>
                                  <asp:ListItem Value="1">보낸사람</asp:ListItem>
                                  <asp:ListItem Value="2">제목</asp:ListItem>
                                  </asp:DropDownList>
                </div>
