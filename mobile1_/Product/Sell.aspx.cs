        ...
        private void TBLLOAD()
        {
            ...
            else if (DropDownList1.SelectedValue == "3")
            {
                ...
                else
                {
                    ...
                    {
                        ADT.SelectCommand.Parameters.AddWithValue("@search", "where to_location like '%" + Search.Text + "%' and  CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' order by no desc");
                    }
                }
            ...
            else if (DropDownList1.SelectedValue == "4")
            {
                ...
                else
                {
                    ...
                    {
                        ADT.SelectCommand.Parameters.AddWithValue("@search", "where product like '%" + Search.Text + "%' and  CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' order by no desc");
                    }
            ...
            else if (DropDownList1.SelectedValue == "5")
            {
                ...
                else
                {
                    ...
                    {
                        ADT.SelectCommand.Parameters.AddWithValue("@search", "where serial like '%" + Search.Text + "%' and  CONVERT(CHAR(10), indate, 23)  between '" + startdate.Text + "' and '" + enddate.Text + "' order by no desc");
                    }
